    ...
    7911: (e, t, s) => {
      ...
      function p(e) {
        let {
          ...
          "/validar-video" === h, [h]), [p, v] = (0, r.useState)(!1), [
          g, b
        ] = (0, r.useState)(900);
        (0, r.useEffect)(() => {
          if (!f) return;
        ...
        let N = (0, r.useMemo)(() => {
          ...
          [B, W] = (0, r.useState)(() => {
            try {
              ...
              let s = window.localStorage ? window.localStorage.getItem("balance") : null;
          ...
          H = (0, r.useEffect)(() => {
            ...
            if (e) {
              let s = parseFloat(e);
              W(Number.isNaN(s) ? 0 : s)
            }
          }, [t]),
          q = (0, r.useEffect)(() => {
            let e = e => {
              try {
                let s = null == e ? void 0 : e.detail;
                let i = s && ("balance" in s ? s.balance : void 0);
                if (typeof i === "string") i = parseFloat(i);
                if (typeof i === "number" && !Number.isNaN(i)) W(i)
              } catch (o) {}
            };
            window.addEventListener("balance:updated", e);
            return () => window.removeEventListener("balance:updated", e)
          }, []),
              ...
              children: [(0, a.jsxs)("div", {
                ...
                children: [(0, a.jsx)("div", {
                  ...
                  children: [(0, a.jsx)("svg", {
                    ...
                    className: "lucide lucide-user-round size-4 text-[#045CA8]",
                    "aria-hidden": "true",
